...
public class LoanApprovedEventHandler : IEventSubscriber<LoanApprovedEvent>
{
    private readonly ISaleRepository _saleRepository;
    private readonly ILoanApplicationRepository _loanApplicationRepository;
    private readonly IEventBus _eventBus;

    public LoanApprovedEventHandler(
    ...
    public async Task HandleAsync(LoanApprovedEvent domainEvent, CancellationToken cancellationToken = default)
    {
